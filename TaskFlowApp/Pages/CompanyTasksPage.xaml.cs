...
public partial class CompanyTasksPage : ContentPage
{
    private CompanyTasksPageViewModel ViewModel => (CompanyTasksPageViewModel)BindingContext;

    public CompanyTasksPage(CompanyTasksPageViewModel viewModel)
    {
        InitializeComponent();
