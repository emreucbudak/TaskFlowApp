...
{
    private NotificationsPageViewModel ViewModel => (NotificationsPageViewModel)BindingContext;

    public NotificationsPage()
    {
        InitializeComponent();
        BindingContext = ServiceLocator.GetRequiredService<NotificationsPageViewModel>();
    }
